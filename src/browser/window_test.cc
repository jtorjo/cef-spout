...
#include "src/browser/window_test_runner.h"

#if defined(OS_WIN) || defined(OS_LINUX)
#include "src/browser/window_test_runner_views.h"
#endif

#if defined(OS_WIN)
#include "src/browser/window_test_runner_win.h"
#elif defined(OS_LINUX)
#include "src/browser/window_test_runner_gtk.h"
#elif defined(OS_MACOSX)
#include "src/browser/window_test_runner_mac.h"
#endif
